...
@section('body')
    ...
    <div class="layui-layout layui-layout-admin">
                ...
                <ul class="layui-nav layui-nav-tree ">
                    @foreach(\ZealovNav::CatgoryTree() as $key=>$value)
                        <li class="layui-nav-item">
                            <a href="#{{$value['label']}}_{{$value['id']}}">{{$value['name']}}1232</a>
        ...
        <div class="layui-body">
            <div class="main-content">
                @foreach(\ZealovNav::navAll() as $key=>$value)
                    <h4 class="text-gray" id="{{$value['label']}}_{{$value['id']}}"><i class="linecons-tag" style="margin-right: 7px;"
                                             id="常用推荐"></i>{{$value['name']}}</h4>
        ...
        <div class="layui-footer">
            <!-- 底部固定区域 -->
            Copyright &copy; 2023 备案号：<a href="{{app('SystemConfig')->value('siteBeianGonganLink')}}"
